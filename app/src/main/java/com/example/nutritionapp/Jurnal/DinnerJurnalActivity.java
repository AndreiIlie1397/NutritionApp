...
import com.example.nutritionapp.Holder.DinnerExpandableListViewAdapter;
...
public class DinnerJurnalActivity extends AppCompatActivity {
    FirebaseDatabase mDatabase;
    DatabaseReference mReference;
    ExpandableListView expandableListView;
    DinnerExpandableListViewAdapter customExpandableListViewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dinner_jurnal);
        ...
        initListData();
        customExpandableListViewAdapter = new DinnerExpandableListViewAdapter(this, listDataHeader, listDataChild);
    ...
    private void initListData() {
        ...
        DatabaseReference rootRef =  mReference.child(getString(R.string.jurnal)).child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(currentDate).child(getString(R.string.dinner));
        ...
        mReference.child(getString(R.string.jurnal)).child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(currentDate).child(getString(R.string.dinner))
