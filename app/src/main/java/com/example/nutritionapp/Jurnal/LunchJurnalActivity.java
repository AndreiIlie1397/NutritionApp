...
import com.example.nutritionapp.Holder.LunchExpandableListViewAdapter;
...
public class LunchJurnalActivity extends AppCompatActivity {
    FirebaseDatabase mDatabase;
    DatabaseReference mReference;
    ExpandableListView expandableListView;
    LunchExpandableListViewAdapter customExpandableListViewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lunch_jurnal);
        ...
        initListData();
        customExpandableListViewAdapter = new LunchExpandableListViewAdapter(this, listDataHeader, listDataChild);
    ...
    private void initListData() {
        ...
        DatabaseReference rootRef =  mReference.child(getString(R.string.jurnal)).child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(currentDate).child(getString(R.string.lunch));
        ...
        mReference.child(getString(R.string.jurnal)).child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(currentDate).child(getString(R.string.lunch))
