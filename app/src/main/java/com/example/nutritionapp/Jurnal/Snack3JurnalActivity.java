...
import com.example.nutritionapp.Holder.Snack3ExpandableListViewAdapter;
...
public class Snack3JurnalActivity extends AppCompatActivity {
    FirebaseDatabase mDatabase;
    DatabaseReference mReference;
    ExpandableListView expandableListView;
    Snack3ExpandableListViewAdapter customExpandableListViewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_snack3_jurnal);
        ...
        initListData();
        customExpandableListViewAdapter = new Snack3ExpandableListViewAdapter(this, listDataHeader, listDataChild);
    ...
    private void initListData() {
        ...
        DatabaseReference rootRef =  mReference.child(getString(R.string.jurnal)).child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(currentDate).child(getString(R.string.snack3));
        ...
        mReference.child(getString(R.string.jurnal)).child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(currentDate).child(getString(R.string.snack3))
