...
import com.example.nutritionapp.Holder.Snack2ExpandableListViewAdapter;
...
public class Snack2JurnalActivity extends AppCompatActivity {
    FirebaseDatabase mDatabase;
    DatabaseReference mReference;
    ExpandableListView expandableListView;
    Snack2ExpandableListViewAdapter customExpandableListViewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_snack2_jurnal);
        ...
        initListData();
        customExpandableListViewAdapter = new Snack2ExpandableListViewAdapter(this, listDataHeader, listDataChild);
    ...
    private void initListData() {
        ...
        DatabaseReference rootRef =  mReference.child(getString(R.string.jurnal)).child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(currentDate).child(getString(R.string.snack2));
        ...
        mReference.child(getString(R.string.jurnal)).child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(currentDate).child(getString(R.string.snack2))
