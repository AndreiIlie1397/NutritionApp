...
import com.example.nutritionapp.Holder.Snack1ExpandableListViewAdapter;
...
public class Snack1JurnalActivity extends AppCompatActivity {
    FirebaseDatabase mDatabase;
    DatabaseReference mReference;
    ExpandableListView expandableListView;
    Snack1ExpandableListViewAdapter customExpandableListViewAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_snack1_jurnal);
        ...
        initListData();
        customExpandableListViewAdapter = new Snack1ExpandableListViewAdapter(this, listDataHeader, listDataChild);
    ...
    private void initListData() {
        ...
        DatabaseReference rootRef =  mReference.child(getString(R.string.jurnal)).child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(currentDate).child(getString(R.string.snack1));
        ...
        mReference.child(getString(R.string.jurnal)).child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(currentDate).child(getString(R.string.snack1))
