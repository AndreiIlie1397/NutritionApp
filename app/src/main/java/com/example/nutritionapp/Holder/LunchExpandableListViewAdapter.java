...
public class LunchExpandableListViewAdapter extends BaseExpandableListAdapter {
    ...
    public LunchExpandableListViewAdapter(Context context, List<String> headerItem, HashMap<String, List<String>> childItem) {
            ...
            public void onClick(View v) {
                ...
                alertDialog.setButton(AlertDialog.BUTTON_POSITIVE, "OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Query query = mReference.child("Jurnal").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(currentDate).child("lunch");
